...
print('Bienvenido(a) al negocio de venta de Equipo de Computo')
print(separador)
    ...
    try:
        with sqlite3.connect("BD_PIA.db") as conn: #1 Establezco conexion
            ...
            while True:
                ...
                print("\Digite la fecha en el siguiente formato DD/MM/YY")
                fecha = input("Fecha:")
                ...
                while True: # While para varios equipos en misma venta

                    # Sistema de obtención de descripción del producto
                    while True:
                        descripcion = input('Introduzca descripción del tipo de Equipo (Ej: Asus)\n» ')
                    ...
                    while True:
                        ...
                        cantidadVenta = input('Introduzca cantidad a vender del tipo de equipo\n» ')
                        try:
                    ...
                    while not validaNumeroFloat:
                        try:
                            precioVenta = float(input('Introduzca precio (sin iva) del tipo de equipo (por unidad)\n» $'))
                            if precioVenta > 0:
